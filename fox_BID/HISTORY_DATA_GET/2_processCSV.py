s_folder='SOURCE_CSV\\'
e_folder='TEMP_CSV\\'
csv_file=['BID','PMI','NMI']
csv_save_filename=['景氣指標','製造業採購經理人PMI','非製造業經理人NMI']
...
csv_file2 = open(e_folder+csv_save_filename[0]+".csv", "w")
...
csv_file2 = open(e_folder+csv_save_filename[1]+".csv", "w")
...
csv_file2 = open(e_folder+csv_save_filename[2]+".csv", "w")
